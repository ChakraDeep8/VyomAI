...
from models import GroqChat, ImageChat, PdfChat, Text2Image, Text2Audio
    ...
    if example == 1:
        ...
        with st.sidebar:
            selected = option_menu(
                ...
                options=["Home", "Image", "Pdf", "Text 👉 Image", "Text 👉  Audio"],  # required
                icons=["house", "camera", "envelope", "sunset"],  # optional
